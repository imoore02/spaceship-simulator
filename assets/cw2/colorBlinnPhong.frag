...
layout(location = 2) in vec3 v2fAmbient;
layout(location = 3) in vec3 v2fDiffuse;
layout(location = 4) in vec3 v2fSpecular;
layout(location = 5) in float v2fShininess;
layout(location = 6) in vec3 v2fEmissive;
